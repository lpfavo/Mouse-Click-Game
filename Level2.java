 ...
 * Student ID:16723023
 * Date:May 30th,2018
 * Description:This class displays the second level's game interface
 */
...
public class Level2 {
	...
	/**
	 * the constructor is to initialize the components in level2 without parameter
	 */
	public Level2()
	{
      ...
      //initialize the TextArea warningTA to warn the player the action was useless
		...
		op.getBottom().setButtonPicture(op.getBottom().getButtons()[0][5],new ImageIcon("stump3.jpg"));
        op.getBottom().setButtonName(0, 5, "stump3");
        ...
        op.getBottom().setButtonPicture(op.getBottom().getButtons()[3][5],new ImageIcon("stump1.jpg"));
        op.getBottom().setButtonPicture(op.getBottom().getButtons()[5][2],new ImageIcon("stump1.jpg"));
        op.getBottom().setButtonPicture(op.getBottom().getButtons()[5][5],new ImageIcon("stump1.jpg"));
        op.getBottom().setButtonPicture(op.getBottom().getButtons()[5][7],new ImageIcon("stump1.jpg"));
        op.getBottom().setButtonPicture(op.getBottom().getButtons()[9][2],new ImageIcon("stump1.jpg"));
        op.getBottom().setButtonPicture(op.getBottom().getButtons()[9][6],new ImageIcon("stump1.jpg"));
        op.getBottom().setButtonName(3,5,"stump1");
        op.getBottom().setButtonName(5,2,"stump1");
        op.getBottom().setButtonName(5,5,"stump1");
        op.getBottom().setButtonName(5,7,"stump1");
        op.getBottom().setButtonName(9,2,"stump1");
        op.getBottom().setButtonName(9,6,"stump1");
        
        op.getBottom().setButtonPicture(op.getBottom().getButtons()[2][2],new ImageIcon("water2.jpg"));
        op.getBottom().setButtonName(2,2,"water2");
        op.getBottom().setButtonPicture(op.getBottom().getButtons()[3][7],new ImageIcon("water3.jpg"));
        op.getBottom().setButtonName(3,7,"water3");
        op.getBottom().setButtonPicture(op.getBottom().getButtons()[11][7],new ImageIcon("water4.jpg"));
        op.getBottom().setButtonName(11,7,"water4");
        op.getBottom().setButtonPicture(op.getBottom().getButtons()[8][1],new ImageIcon("water4.jpg"));
        op.getBottom().setButtonName(8,1,"water3");
        
        op.getBottom().setButtonPicture(op.getBottom().getButtons()[10][2],new ImageIcon("plank2.jpg"));
        op.getBottom().setButtonPicture(op.getBottom().getButtons()[11][2],new ImageIcon("plank2.jpg"));
        op.getBottom().setButtonName(10,2,"plank2");
        op.getBottom().setButtonName(11,2,"plank2");
        
        op.getBottom().setButtonPicture(op.getBottom().getButtons()[5][6],new ImageIcon("plank1.jpg"));
        op.getBottom().setButtonPicture(op.getBottom().getButtons()[9][3],new ImageIcon("plank1.jpg"));
        op.getBottom().setButtonPicture(op.getBottom().getButtons()[9][4],new ImageIcon("plank1.jpg"));
        op.getBottom().setButtonPicture(op.getBottom().getButtons()[9][5],new ImageIcon("plank1.jpg"));
        op.getBottom().setButtonName(5,6,"plank1");
        op.getBottom().setButtonName(9,3,"plank1");
        op.getBottom().setButtonName(9,4,"plank1");
        op.getBottom().setButtonName(9,5,"plank1");
	 ...
	 * @return JButton Operation .getButtons()[0][5]
	 */
	public JButton getwinButton()
	{
		return this.op.getButtons()[0][5];
	}
	...
	public void exportTable() throws IOException {
		OutputStreamWriter out = new OutputStreamWriter(new FileOutputStream("level2.txt",true),"UTF-8");
