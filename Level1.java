 ...
 * Student ID:16723023
 * Date:May 30th,2018
 * Description:This class displays the first level's game interface
 */
...
public class Level1 {
	...
	/**
	 * the constructor is to initialize the components in level1 without parameter
	 */
	public Level1()
	{
		...
		op.getBottom().setButtonPicture(op.getBottom().getButtons()[0][2],new ImageIcon("stump3.jpg"));
        op.getBottom().setButtonName(0, 2, "stump3");
        op.getBottom().setButtonPicture(op.getBottom().getButtons()[12][6],new ImageIcon("stump2_man.jpg"));
        op.getBottom().setButtonName(12,6,"stump2_man");
        op.setRmanPosition(12);
        op.setCmanPosition(6);
        
        op.getBottom().setButtonPicture(op.getBottom().getButtons()[4][2],new ImageIcon("stump1.jpg"));
        op.getBottom().setButtonPicture(op.getBottom().getButtons()[4][6],new ImageIcon("stump1.jpg"));
        op.getBottom().setButtonPicture(op.getBottom().getButtons()[8][6],new ImageIcon("stump1.jpg"));
        op.getBottom().setButtonName(4,2,"stump1");
        op.getBottom().setButtonName(4,6,"stump1");
        op.getBottom().setButtonName(8,6,"stump1");
        
        op.getBottom().setButtonPicture(op.getBottom().getButtons()[9][2],new ImageIcon("water2.jpg"));
        op.getBottom().setButtonName(9,2,"water2");
        op.getBottom().setButtonPicture(op.getBottom().getButtons()[2][7],new ImageIcon("water3.jpg"));
        op.getBottom().setButtonName(2,7,"water3");
        op.getBottom().setButtonPicture(op.getBottom().getButtons()[6][4],new ImageIcon("water4.jpg"));
        op.getBottom().setButtonName(6,4,"water4");

        
        op.getBottom().setButtonPicture(op.getBottom().getButtons()[9][6],new ImageIcon("plank2.jpg"));
        op.getBottom().setButtonPicture(op.getBottom().getButtons()[10][6],new ImageIcon("plank2.jpg"));
        op.getBottom().setButtonPicture(op.getBottom().getButtons()[11][6],new ImageIcon("plank2.jpg"));
        op.getBottom().setButtonName(9,6,"plank2");
        op.getBottom().setButtonName(10,6,"plank2");
        op.getBottom().setButtonName(11,6,"plank2");
	 ...
	 * @return JButton Operation .getButtons()[0][2]
	 */
	public JButton getwinButton()
	{
		return this.op.getButtons()[0][2];
	}
	...
	public void exportTable() throws IOException {
		OutputStreamWriter out = new OutputStreamWriter(new FileOutputStream("level1.txt",true),"UTF-8");
