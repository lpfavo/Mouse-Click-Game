 ...
 * Student ID:16723023
 * Date:May 30th,2018
 * Description:This class displays the third level's game interface
 */
...
public class Level3 {
	...
	/**
	 * the constructor is to initialize the components in level3 without parameter
	 */
	public Level3()
	{
      ...
      //initialize the TextArea warningTA to warn the player the action was useless
		...
		op.getBottom().setButtonPicture(op.getBottom().getButtons()[0][4],new ImageIcon("stump3.jpg"));
        op.getBottom().setButtonName(0, 4, "stump3");
        op.getBottom().setButtonPicture(op.getBottom().getButtons()[12][4],new ImageIcon("stump2_man.jpg"));
        op.getBottom().setButtonName(12,4,"stump2_man");
        op.setRmanPosition(12);
        op.setCmanPosition(4);
        
        op.getBottom().setButtonPicture(op.getBottom().getButtons()[2][0],new ImageIcon("stump1.jpg"));
        op.getBottom().setButtonPicture(op.getBottom().getButtons()[3][4],new ImageIcon("stump1.jpg"));
        op.getBottom().setButtonPicture(op.getBottom().getButtons()[5][4],new ImageIcon("stump1.jpg"));
        op.getBottom().setButtonPicture(op.getBottom().getButtons()[5][8],new ImageIcon("stump1.jpg"));
        op.getBottom().setButtonPicture(op.getBottom().getButtons()[6][0],new ImageIcon("stump1.jpg"));
        op.getBottom().setButtonPicture(op.getBottom().getButtons()[6][2],new ImageIcon("stump1.jpg"));
        op.getBottom().setButtonPicture(op.getBottom().getButtons()[6][6],new ImageIcon("stump1.jpg"));
        op.getBottom().setButtonPicture(op.getBottom().getButtons()[8][0],new ImageIcon("stump1.jpg"));
        op.getBottom().setButtonPicture(op.getBottom().getButtons()[8][4],new ImageIcon("stump1.jpg"));
        op.getBottom().setButtonPicture(op.getBottom().getButtons()[8][8],new ImageIcon("stump1.jpg"));
        op.getBottom().setButtonPicture(op.getBottom().getButtons()[10][0],new ImageIcon("stump1.jpg"));
        op.getBottom().setButtonName(2,0,"stump1");
        op.getBottom().setButtonName(3,4,"stump1");
        op.getBottom().setButtonName(5,4,"stump1");
        op.getBottom().setButtonName(5,8,"stump1");
        op.getBottom().setButtonName(6,0,"stump1");
        op.getBottom().setButtonName(6,2,"stump1");
        op.getBottom().setButtonName(6,6,"stump1");
        op.getBottom().setButtonName(8,0,"stump1");
        op.getBottom().setButtonName(8,4,"stump1");
        op.getBottom().setButtonName(8,8,"stump1");
        op.getBottom().setButtonName(10,0,"stump1");
        
        op.getBottom().setButtonPicture(op.getBottom().getButtons()[2][2],new ImageIcon("water2.jpg"));
        op.getBottom().setButtonName(2,2,"water2");
        op.getBottom().setButtonPicture(op.getBottom().getButtons()[10][7],new ImageIcon("water3.jpg"));
        op.getBottom().setButtonName(10,7,"water3");
        op.getBottom().setButtonPicture(op.getBottom().getButtons()[2][6],new ImageIcon("water4.jpg"));
        op.getBottom().setButtonName(2,6,"water4");
        
        op.getBottom().setButtonPicture(op.getBottom().getButtons()[9][0],new ImageIcon("plank2.jpg"));
        op.getBottom().setButtonPicture(op.getBottom().getButtons()[9][4],new ImageIcon("plank2.jpg"));
        op.getBottom().setButtonPicture(op.getBottom().getButtons()[10][4],new ImageIcon("plank2.jpg"));
        op.getBottom().setButtonPicture(op.getBottom().getButtons()[11][4],new ImageIcon("plank2.jpg"));
        op.getBottom().setButtonPicture(op.getBottom().getButtons()[6][8],new ImageIcon("plank2.jpg"));
        op.getBottom().setButtonPicture(op.getBottom().getButtons()[7][8],new ImageIcon("plank2.jpg"));
        op.getBottom().setButtonName(9,0,"plank2");
        op.getBottom().setButtonName(9,4,"plank2");
        op.getBottom().setButtonName(10,4,"plank2");
        op.getBottom().setButtonName(11,4,"plank2");
        op.getBottom().setButtonName(6,8,"plank2");
        op.getBottom().setButtonName(7,8,"plank2");
        
        
        op.getBottom().setButtonPicture(op.getBottom().getButtons()[6][3],new ImageIcon("plank1.jpg"));
        op.getBottom().setButtonPicture(op.getBottom().getButtons()[6][4],new ImageIcon("plank1.jpg"));
        op.getBottom().setButtonPicture(op.getBottom().getButtons()[6][5],new ImageIcon("plank1.jpg"));
        op.getBottom().setButtonName(6,3,"plank1");
        op.getBottom().setButtonName(6,4,"plank1");
        op.getBottom().setButtonName(6,5,"plank1");
	 ...
	 * @return JButton Operation .getButtons()[0][4]
	 */
	public JButton getwinButton()
	{
		return this.op.getButtons()[0][4];
	}
	...
	public void compareHisRecord() throws IOException{
		BufferedReader br = new BufferedReader(new FileReader("level3.txt"));
		String shortTime="";
		String name="";
		String time="";
	...
	public void exportTable() throws IOException {
		OutputStreamWriter out = new OutputStreamWriter(new FileOutputStream("level3.txt",true),"UTF-8");
